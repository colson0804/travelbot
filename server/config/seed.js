...
/* Tags: Landmark/Historic, Outdoors, Show/Theater, Museum/Gallery, Sports, Restaurants/Bars, Nightlife and Shopping */
...
Place.find({}).remove(function() {
  Place.create({
    ...
    tags: ['Landmark/Historic', 'Outdoors']
  }, {
    ...
    tags: ['Restaurants/Bars', 'Landmark/Historic']
  }, {
    name: 'Willis Tower',
